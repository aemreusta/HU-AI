...
public class Project implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        // This logic checks if all tasks in 'project.tasks' are present in 'this.tasks'
        // and all tasks in 'this.tasks' are present in 'project.tasks'.
        // Since sizes are equal, one direction is sufficient if Task.equals is symmetric.
    ...
    // (content of tasks matters, order does not)
    @Override
    public int hashCode() {
        // Sort tasks by a consistent criteria (e.g., TaskID) before hashing the list
        // to ensure order-insensitivity for the list part of the hash.
